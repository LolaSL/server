...
module.exports = class Usermodel {
    async create(data) {
        let text = `INSERT INTO users(id, email, password, first_name, last_name, address, postcode, city, country)
        VALUES( $2, $3, $4, $5, $6, $7, $8, $9) RETURNING id = 1$*`;

        let inputs = [data.id, data.email, data.password, data.first_name, data.last_name, data.address, data.postcode, data.city, data.country,];
        console.log(inputs)
